...
class AboutOneViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let isEnglish = BeginViewController.defaults.bool(forKey: BeginViewController.GET_IS_ENGLISH)
        
        if isEnglish {
            print("demo_text".localized(language: "en"))
        }
        else {
            print("demo_text".localized(language: "zh-Hant"))
        }
