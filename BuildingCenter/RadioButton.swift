...
public class  RadioButton: UIButton {
    ...
    @IBOutlet var otherButtons: Array<RadioButton>?
    ...
    private var setOtherButtons:NSArray {
        ...
        set (newValue) {
            if (!self.isGroupModifing()){
                ...
                let otherNewButtons:Array<RadioButton>? = newValue as? Array<RadioButton>
            ...
            self.otherButtons = newValue as? Array<RadioButton>
        }
    }
    ...
    func drawIconWithSelection (_ selected:Bool) -> UIImage{
        ...
        image.accessibilityIdentifier = RadioButton.kGeneratedIconName;
        return image;
    }
    ...
    func initRadioButton () {
        super.addTarget(self, action:#selector(RadioButton.touchDown), for:.touchUpInside)
        //        self.isSelected = false
    }
    ...
    func groupModifing(chaining:Bool) {
        RadioButton._groupModifing = chaining
    }
    
    func isGroupModifing() -> Bool {
        return RadioButton._groupModifing
    }
